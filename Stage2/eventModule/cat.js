...
var colors = ['\x1b[31m', '\x1b[32m', '\x1b[34m', '\x1b[0m']
for(let i = 0; i< colors.length; i++){
    animalFarm.addListener(listeners[i], function(argument){console.log(colors[i] + listeners[i]+": "+argument + colors[colors.length]);});
}
